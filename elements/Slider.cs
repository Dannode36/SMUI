        ...
        *********/
        ...
        public override void Update(bool isOffScreen = false)
        {
            ...
            if (this.Dragging)
            {
                ...
                this.Value = Utilities.Adjust(this.Value, this.Interval);
                this.Value = this.Value switch
                {
                    int => Utilities.Clamp<T>(this.Minimum, (T)(object)(int)(perc * ((int)(object)this.Maximum - (int)(object)this.Minimum) + (int)(object)this.Minimum), this.Maximum),
                    float => Utilities.Clamp<T>(this.Minimum, (T)(object)(perc * ((float)(object)this.Maximum - (float)(object)this.Minimum) + (float)(object)this.Minimum), this.Maximum),
                    _ => this.Value
                };
